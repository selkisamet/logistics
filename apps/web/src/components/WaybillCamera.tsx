...
/** İzin al, cihazları etiketleriyle tarayıp ARKA ANA kamerayı seç ve aç (çoklu kamerada siyah ekranı önler). */
...
/**
 * İrsaliye No'yu uygulama İÇİNDE, arka kamerayla okur — sayfa HİÇ yenilenmez.
 * Önizleme yumuşak olsa bile çekim ImageCapture.takePhoto() ile tam çözünürlükte + odak
 * tetiklenerek alınır. Ekrana dokunarak da odaklanabilir. Kamera yalnızca https/localhost'ta açılır.
 */
export function WaybillCamera({
  ...
  /** Ekrana dokununca o noktaya odaklan (destekleyen cihazlarda). */
  ...
  const grabPhoto = async (): Promise<Blob | null> => {
    ...
    // Çekimden hemen önce odağı tetikle ve otursun.
    try {
